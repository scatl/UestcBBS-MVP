...
public class ForumUtil {
    ...
    public static int getLevelColor(String userLevel) {
        if (("蝌蚪 (Lv.1)").equals(userLevel)) {
            return MyApplication.getContext().getColor(R.color.level_color_1);
        }
        if (("虾米 (Lv.2)").equals(userLevel)) {
            return MyApplication.getContext().getColor(R.color.level_color_2);
        }
        if (("河蟹 (Lv.3)").equals(userLevel)) {
            return MyApplication.getContext().getColor(R.color.level_color_3);
        }
        if (("泥鳅 (Lv.4)").equals(userLevel)) {
            return MyApplication.getContext().getColor(R.color.level_color_4);
        }
        if (("草鱼 (Lv.5)").equals(userLevel)) {
            return MyApplication.getContext().getColor(R.color.level_color_5);
        }
        if (("鳙鱼 (Lv.6)").equals(userLevel)) {
            return MyApplication.getContext().getColor(R.color.level_color_6);
        }
        if (("鲤鱼 (Lv.7)").equals(userLevel)) {
            return MyApplication.getContext().getColor(R.color.level_color_7);
        }
        if (("鲶鱼 (Lv.8)").equals(userLevel)) {
            return MyApplication.getContext().getColor(R.color.level_color_8);
        }
        if (("白鳍 (Lv.9)").equals(userLevel)) {
            return MyApplication.getContext().getColor(R.color.level_color_9);
        }
        if (("海豚 (Lv.10)").equals(userLevel)) {
            return MyApplication.getContext().getColor(R.color.level_color_10);
        }
        ...
        if ("水藻河泥 (Lv.0 禁言中…)".equals(userLevel)) {
            return MyApplication.getContext().getColor(R.color.level_forbidden);
        }
        ...
        if ("管理员".equals(userLevel)) {
            return MyApplication.getContext().getColor(R.color.level_bbs_web_manager);
        }
        ...
        if ("清水河畔VIP".equals(userLevel)) {
            return MyApplication.getContext().getColor(R.color.level_other_user_group);
        }
        ...
        if ("站长".equals(userLevel)) {
            return MyApplication.getContext().getColor(R.color.level_bbs_web_master);
        }

        return MyApplication.getContext().getColor(R.color.colorPrimary);
    }
